                            ...
                            <div class="row">
                                <div class="col-4 align-content-center">
                                    <a href="{{ route('users.index') }}" class="text-decoration-none">
                                        <div class="d-flex justify-content-center align-items-center icon-sm bg-gradient-dark shadow border-radius-md">
                                            <i class="fas fa-arrow-left text-xs opacity-10" aria-hidden="true" style="color: #ffff;"></i>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-8">
                                    <div class="numbers mt-1 d-flex align-items-center">
                                        ...
                                        <i class="fa-solid fa-circle-info" style="color: #1f3051; font-size: 1.5rem;"></i>
                                    </div>
                                </div>
                ...
                <div class="row gx-4">  
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ $user->photo1 ? $user->photo1 : asset('assets/img/team-2.jpg') }}" alt="..."
