                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7">Usuario
                                            </th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">Administrador</p>
                                                <p class="text-sm text-secondary mb-0">Eventos</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="badge badge-sm border border-success text-success bg-success">En línea</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">Desarrollador</p>
                                                <p class="text-sm text-secondary mb-0">Web</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-sm text-secondary mb-0">Proyectos</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="badge badge-sm border border-success text-success bg-success">En línea</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">Jefe</p>
                                                <p class="text-sm text-secondary mb-0">Producción</p>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="badge badge-sm border border-secondary text-secondary bg-secondary">Offline</span>
