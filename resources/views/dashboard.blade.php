                ...
                <div class="col-md-12">
                    <div class="d-md-flex align-items-center mb-3 mx-2">
                        <div class="mb-md-0 mb-3">
                            <h3 class="font-weight-bold mb-0">Hola, Take</h3>
                            <p class="mb-0">Apps que te pueden gustar!</p>
                        </div>
                        {{-- <button type="button"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div
                                    ...
                                    <div class="full-background bg-cover"
                                        style="background-image: url('../assets/img/img2.jpg')"></div>
                                    <div class="card-body text-start px-3 py-0 w-100">
                                        <div class="row mt-12">
                                            <div class="col-sm-3 mt-auto">
                                                <h4 class="text-white font-weight-bolder">#2</h4>
                                                <p class="text-white opacity-6 text-xs font-weight-bolder mb-0">Nombre</p>
                                                <h5 class="text-white font-weight-bolder">The Strokes</h5>
                                            </div>
                                            <div class="col-sm-3 ms-auto mt-auto">
                                                <p class="text-white opacity-6 text-xs font-weight-bolder mb-0">Categoria
                                                </p>
                                                <h5 class="text-white font-weight-bolder">Rock</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                                    <div class="full-background bg-cover"
                                        style="background-image: url('../assets/img/img3.jpg')"></div>
                                    <div class="card-body text-start px-3 py-0 w-100">
                                        <div class="row mt-12">
                                            <div class="col-sm-3 mt-auto">
                                                <h4 class="text-white font-weight-bolder">#3</h4>
                                                <p class="text-white opacity-6 text-xs font-weight-bolder mb-0">Nombre</p>
                                                <h5 class="text-white font-weight-bolder">Coldplay</h5>
                                            </div>
                                            <div class="col-sm-3 ms-auto mt-auto">
                                                <p class="text-white opacity-6 text-xs font-weight-bolder mb-0">Categoria
                                                </p>
                                                <h5 class="text-white font-weight-bolder">Música</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                                    <div class="full-background bg-cover"
                                        style="background-image: url('../assets/img/img4.jpg')"></div>
                                    <div class="card-body text-start px-3 py-0 w-100">
                                        <div class="row mt-12">
                                            <div class="col-sm-3 mt-auto">
                                                <h4 class="text-white font-weight-bolder">#4</h4>
                                                <p class="text-white opacity-6 text-xs font-weight-bolder mb-0">Nombre</p>
                                                <h5 class="text-white font-weight-bolder">AMC</h5>
                                            </div>
                                            <div class="col-sm-3 ms-auto mt-auto">
                                                <p class="text-white opacity-6 text-xs font-weight-bolder mb-0">Categoria
                                                </p>
                                                <h5 class="text-white font-weight-bolder">Oscar</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                                    <div class="full-background bg-cover"
                                        style="background-image: url('../assets/img/img5.jpg')"></div>
                                    <div class="card-body text-start px-3 py-0 w-100">
                                        <div class="row mt-12">
                                            <div class="col-sm-3 mt-auto">
                                                <h4 class="text-white font-weight-bolder">#5</h4>
                                                <p class="text-white opacity-6 text-xs font-weight-bolder mb-0">Nombre</p>
                                                <h5 class="text-white font-weight-bolder">Tom Cruise</h5>
                                            </div>
                                            <div class="col-sm-3 ms-auto mt-auto">
                                                <p class="text-white opacity-6 text-xs font-weight-bolder mb-0">Categoria
                                                </p>
                                                <h5 class="text-white font-weight-bolder">Peliculas</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column h-100">
                                        <p class="mb-1 pt-2 text-bold">Fotografias</p>
                                        <h5 class="font-weight-bolder">TakePhotos</h5>
                                        <p class="mb-5">Un software basado en inteligencia artificial para la detección de personas.</p>
                                    </div>
                                </div>
                                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                    <div class="bg-gradient-dark border-radius-lg" style="width: 100%; height: 100%;">
                                        <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                            <img class="w-100 h-100 position-relative border-radius-lg z-index-3" src="../assets/img/img6.jpeg" alt="Imagen de fondo" style="object-fit: cover;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card h-100 p-3">
                        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                            ...
                            <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                <h5 class="text-white font-weight-bolder mb-4 pt-2">Totalmente actualizados</h5>
                                <p class="text-white">Estamos al tanto de todas las novedades posibles con respecto a la gestión de fotografias.!</p>
